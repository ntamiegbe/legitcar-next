    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-grayBg p-5">
                ...
                <div className="max-w-5xl bg-white border border-dashboardBorders rounded-lg opacity-[90%]">
                    <div className="text-secondaryText pt-5 border-stroke text-start px-5 w-full border-b pb-3 text-md font-normal">
                        My vehicles
                    </div>
